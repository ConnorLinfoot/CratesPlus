...
public class NBTReflectionUtil {
	...
	/**
	 * This is something I've added... not even sure if this will work with my limited NMS/Reflection knowledge
	 */
	public static Map<String, Object> getMap(ItemStack item) {
		Object nmsitem = getNMSItemStack(item);
		if (nmsitem == null) {
			System.out.println("Got null! (Outdated Plugin?)");
			return null;
		...
		try {
			Field field = nbttag.getClass().getDeclaredField("map");
			field.setAccessible(true);
			return (Map<String, Object>) field.get(nbttag);
